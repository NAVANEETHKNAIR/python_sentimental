...
class TwitterData:
    ...
    def parse_config(self):
      ...
      if os.path.exists('config.json'):
          ...
          parser.add_argument('-ck', 'exXFYZluF7zKoXfw1wAyfs6E5', default=None, help='Your developper `Consumer Key`')
          parser.add_argument('-cs', 'w19yAGsBKr3UmVinfwfw6fati6fYVba0LaSlbcaI6GisqEp8zU', default=None, help='Your developper `Consumer Secret`')
          parser.add_argument('-at', '3394668587-felSLvsnXu3qDJN6mRBnWJAzEF8nCTwehkCaVGm', default=None, help='A client `Access Token`')
          parser.add_argument('-ats', 'UjP87tovOYNvXLPLp9IsgIrvMrXfpzS5iAG9F5Vyl4nxd', default=None, help='A client `Access Token Secret`')
